...
def test_all_commands():
    ...
    COMMAND_ARGS = {
        ...
        "refine-and-send-prompt": "--verbose --refinement-model 'qwen3-1.7b-mlx' --output-model 'qwen3-1.7b-mlx' -p 'Generate a detailed plan on how to get rich.'",
        "refine-prompt": "-m 'qwen3-1.7b-mlx' -p 'Generate a detailed plan on how to get rich.'",
        "send-prompt": "-m 'qwen3-1.7b-mlx' 'Hi, who are you?'"
    }
